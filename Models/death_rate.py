...
training_set = dataset_train.iloc[0:133, 2:3].values
...
real_death_case = dataset_train.iloc[:134, 2:3].values

#predicting the future data
dataset_total = pd.concat((dataset_train['New Deaths'], dataset_test['New Deaths']), axis = 0)
...
plt.plot(predicted_death_case, color = 'blue', label = 'Predicted Covid-19 Death Rates')
